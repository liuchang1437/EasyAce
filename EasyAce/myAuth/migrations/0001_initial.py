# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-08-14 05:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intent_start_time', models.CharField(max_length=8, verbose_name='start time')),
        ...
        migrations.AddField(
            model_name='studentintent',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='intents', to='myAuth.Student'),
        ),
        migrations.AddField(
            model_name='student',
            name='tutors_chosen',
